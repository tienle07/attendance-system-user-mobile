...
class DropdownStoreInShiftItems extends StatefulWidget {
  final Function(DropdownStore?) onItemSelectedStoreInShift;

  const DropdownStoreInShiftItems(
      {Key? key, required this.onItemSelectedStoreInShift})
      : super(key: key);

  @override
  _DropdownStoreInShiftItemsState createState() =>
      _DropdownStoreInShiftItemsState();
}

class _DropdownStoreInShiftItemsState extends State<DropdownStoreInShiftItems> {
    ...
    return SizedBox(
      child: DropdownButtonFormField2<DropdownStore>(
        ...
        onChanged: (value) {
          ...
          widget.onItemSelectedStoreInShift(_selectedStore);
        },
